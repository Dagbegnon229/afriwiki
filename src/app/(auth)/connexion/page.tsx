    ...
    <>
      ...
      <nav className="tabs-nav">
        <div className="tabs-left">
          <Link href="/connexion" className="tab active">
            Se connecter
          </Link>
        ...
        <main className="content-wrapper">
          <div className="auth-container">
            ...
            <div className="notice-box" style={{ marginTop: "1rem" }}>
              <strong>Note :</strong> La connexion vous permet de créer et
              modifier votre page entrepreneur, de suivre d&apos;autres profils
